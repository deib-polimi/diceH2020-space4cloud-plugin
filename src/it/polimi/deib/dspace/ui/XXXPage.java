...
public class XXXPage extends WizardPage{
	private static final Logger LOGGER = Logger.getLogger( XXXPage.class.getName() );
	...
	protected XXXPage(String title, String description) {
		super("Browse Files");
		setTitle(title);
...
/*    			for(File I:chosenFiles){
            		if(getFileExtension(I.getPath()).equals("xxx")){
